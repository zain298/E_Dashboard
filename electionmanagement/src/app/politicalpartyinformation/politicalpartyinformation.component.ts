        ...
        (response) => {
          if (response) {
            ...
            if (response.error && response.status) {
              ...
              this.toastrservice.info("New Political Party Record Added");
        ...
        (response) => {
          if (response) {
            if (response.error && response.status) {
              ...
              this.toastrservice.success("Success");
              this.toastrservice.info("Political Party Record Deleted");
              this.politicalpartyinformation = response;
              this.getAll();
        ...
        (response) => {
          if (response) {
            if (response.error && response.status) {
              ...
              this.toastrservice.success("Success");
              this.toastrservice.info("Political Party Record Updated");
              this.politicalpartyinformation = response;
              this.getAll();
              $("#editModal").modal("hide");
            } else {
