  ...
  { path: "404", component: NotFoundComponent },
  {
    ...
    children: [
      ...
      { path: "electioninformation", component: ElectioninformationComponent },
      {
        ...
        component: ElectionblockcodeinformationComponent,
      },
      {
        path: "electioncontituencyinformation",
        component: ElectioncontituencyinformationComponent,
      },
      {
        path: "electioncontituencypollingstationinformation",
        component: ElectioncontituencypollingstationinformationComponent,
      },
      {
        path: "electioncontituencypollingstationdetailinformation",
        component: ElectioncontituencypollingstationdetailinformationComponent,
      },
      {
        path: "electioncontituencypollingstationresultinformation",
        component: ElectioncontituencypollingstationresultinformationComponent,
      },
      {
        path: "politicalpartyinformation",
        component: PoliticalpartyinformationComponent,
      },
      {
        path: "politicalpartycandidateinformation",
        component: PoliticalpartycandidateinformationComponent,
      },
      ...
      {
        path: "electionvoterinformation",
        component: ElectionvoterinformationComponent,
      },
