...
export class PersoninformationComponent implements OnInit {
  ...
  View(personinformation) {
    const url =
      "view/demo/" + personinformation.data.election_ID + "/DemoviewOne";
  ...
  Delete(row) {
    ...
    this.personinformationservice.delete(row.data.person_ID).subscribe(
      (response) => {
        if (response) {
          if (response.error && response.status) {
            ...
            this.toastrservice.info("Person Record Deleted");
  ...
  add(personinformation) {
    ...
    // }
    this.personinformationservice.add(personinformation).subscribe(
      (response) => {
        if (response) {
          console.log(response);
          ...
          if (response.error && response.status) {
            ...
            this.toastrservice.info("New Person Record Added");
  ...
  update(personinformation) {
    ...
    //   personinformation.electiontype_ID== null;
    // }
    this.personinformationservice
      .update(personinformation, personinformation.person_ID)
      .subscribe(
        (response) => {
          if (response) {
            if (response.error && response.status) {
              ...
              this.toastrservice.success("Success");
              this.toastrservice.info("Person Record Updated");
